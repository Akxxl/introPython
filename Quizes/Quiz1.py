...
giftCardGiven = 100.00
addedToGiftCard = 50.00
friendGivesYou = 35.00
...
alllergy = input("do u have any allergys")
...
allergy = input("do you have a gluten allergy")
yesNo = input("do you want gluten free bread")

# 9. In your own words, describe what a program is?

"a program is something that controls stuff""

# 10. Describe the difference between a float and an integer. 
"a fleat is a number with a decimal and an integer is a whole number"
